...
│              │ │              │ │  (Graph)     │ │           │ │            │
│ - metadata   │ │ - 768-dim    │ │ - citation   │ │ - cache   │ │ - original │
...
| 6 | EmbeddingProvider | Gemini text-embedding-004 (768-dim) | List of float vectors |
...
RRF gives us a good candidate set, but a cross-encoder (Cohere rerank-v3) can do pairwise query-document attention — something neither vector search nor BM25 can do. The reranker reads both the query and each document together, producing a much more accurate relevance score.
