...
async def search(
    ...
    bench_type: str | None = Query(None, max_length=50, description="Filter by bench type"),
    judge: str | None = Query(None, max_length=200, description="Filter by judge name"),
    act: str | None = Query(None, max_length=100, description="Filter by act cited"),
